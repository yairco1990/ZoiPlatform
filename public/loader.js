...
function startZoi() {
	...
	Promise.all([
		...
		console.log("finish to load css files. " + (scriptsStartTime - cssStartTime) + " ms");
		...
		Promise.all([
			...
			console.log("finish to load script files. " + (scriptsEndTime - scriptsStartTime) + " ms");
			console.log("total loader time - " + (scriptsEndTime - cssStartTime) + " ms");
